 ...
 * Created by PK
 */
public class VideoChallangeExample {
    ...
    public  static void main(String args[]) {
        ...
        try {
            new VideoChallangeExample().sendPost();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void sendPost() throws Exception {
        ...
        String requestURL = AppConfig.API_BASE_URL + "/video/challenge";
        ...
        String params = "no_of_challenges=2"; //-- enrolled face id
//        HttpPost post = new HttpPost(requestURL + "?" + params);
        HttpGet post = new HttpGet(requestURL + "?" + params);
        ...
        builder.addBinaryBody("face_image", faceImage, ContentType.parse("image/jpeg"), faceImage.getName());
