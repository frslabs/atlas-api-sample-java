 ...
 * Created by PK
 */
public class EnrollFaceExample {
    ...
    public  static void main(String args[]) {
        ...
        try {
            new EnrollFaceExample().sendPost();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void sendPost() throws Exception {
        ...
        String requestURL = AppConfig.API_BASE_URL + "/face/enrol";
        ...
        File imgFile = new File("D:\\Temp\\temp\\00b85b02_23ac0b4a-3516-4461-b995-59642f58aee2.jpg");

        builder.addBinaryBody("face_image", imgFile, ContentType.parse("image/jpeg"), imgFile.getName());
